<template>
	<article>
		<h1 class="loud-voice">Terms</h1>
		<p>
			Please read these terms and conditions carefully before using Our
			Service.
		</p>
		<h2 class="attention-voice">Interpretation and Definitions</h2>
		<h3 class="firm-voice">Interpretation</h3>
		<p>
		...
		<h3 class="firm-voice">Definitions</h3>
		...
		<ul>
			...
			<li>
				<p>
					...
					<strong>"Our"</strong> in this Agreement) refers to HungerBuster.
				</p>
			</li>
			<li>
			...
			<li>
				<p>
					...
					<strong>"Terms"</strong>) mean these Terms and Conditions that
			...
			<li>
				<p>
					<strong>Website</strong> refers to HungerBuster, accessible from
					<a
						href="https://hungerbuster.netlify.app/"
						rel="external nofollow noopener"
						target="_blank"
					>
						https://hungerbuster.netlify.app/
					</a>
				</p>
			</li>
			<li>
		...
		<h2 class="attention-voice">Acknowledgement</h2>
		<p>
			These are the Terms and Conditions governing the use of this Service
			and the agreement that operates between You and the Company. These
			Terms and Conditions set out the rights and obligations of all
			participants in respect of the use of the Service.
		</p>
		<p>
		...
		<h2 class="attention-voice">Links to Other Websites</h2>
		<p>
		...
		<h2 class="attention-voice">Termination</h2>
		<p>
		...
		<h2 class="attention-voice">Limitation of Liability</h2>
		<p>
			Notwithstanding any damages that You might incur, the entire liability
			of the Company and any of its suppliers under any provision of this
			Terms and Your exclusive remedy for all of the foresaid shall be
		...
		<h2 class="attention-voice">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
		<p>
